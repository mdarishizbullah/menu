...
function tambahKeranjang(id_product){
	...
	xhr.open('POST','php/tambahCartManager.php',true);
...
function hitungKeranjang(){
  ...
  xhttp.open("GET", "php/jumlahCartManager.php", true);
  xhttp.send();
}
...
function isiCart(){
	...
	fetch('php/detailCartManager.php').then(response => response.json()).then(response => {
		let barisData ='';
		for(i = 0; i < response.length; i++){
...
function hapusData(id_produk){
	let xhr = new XMLHttpRequest();
	xhr.open('POST','php/hapusCartManager.php',true);
	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhr.onload = function(){
	}
...
function merubah(id_produk){
	...
	let xhr = new XMLHttpRequest();
	xhr.open('POST','php/merubahCartManager.php',true);
	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhr.onload = function(){
	}
...
function pesanSekarang(){
	...
	let xhr = new XMLHttpRequest();
	xhr.open('POST','php/pesanSekarangCartManager.php',true);
	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	xhr.onload = function(){
		}
...
function deleteAllCart(){
  ...
  xhttp.open("GET", "php/hapusAllCartManager.php", true);
  xhttp.send();
}
...
function hitungDone(){
  ...
  xhttp.open("GET", "php/jumlahHistoryManager.php", true);
  xhttp.send();
}

function isiDone(){
	let container = document.getElementById("sebelumNota");
	fetch('php/detailDoneManager.php').then(response => response.json()).then(response => {
		let barisData ='';
		for(i = 0; i < response.length; i++){
